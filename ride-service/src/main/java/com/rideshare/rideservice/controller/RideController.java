...
public class RideController {
    ...
    public ResponseEntity<List<RideResponse>> getAllRidesByRiderId(
            @PathVariable String riderId
    ){
        log.info("Fetching all rides for rider: {}", riderId);
        return ResponseEntity.ok(rideService.getAllRidesByRiderId(riderId));
    }
